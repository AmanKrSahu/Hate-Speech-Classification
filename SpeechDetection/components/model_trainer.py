...
from SpeechDetection.entity.artifact_entity import ModelTrainerArtifacts, DataTransformationArtifacts
from SpeechDetection.ml.model import ModelArchitecture
